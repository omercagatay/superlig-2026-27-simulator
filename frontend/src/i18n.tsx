...
const DICT = {
  ...
  xPts: ["xPts", "bPuan"],
  xGD: ["xGD", "bAverage"],
  tipUcl: ["Champions League (1st-2nd)", "Şampiyonlar Ligi (1-2.)"],
  tipUel: ["Europa League (3rd)", "Avrupa Ligi (3.)"],
  tipUecl: ["Conference League (4th)", "Konferans Ligi (4.)"],
  tipEurope: ["Any European place (1st-4th)", "Herhangi bir Avrupa kupası (1-4.)"],
  ...
  europeanPlaces: ["European places (1-4)", "Avrupa kupası sıraları (1-4)"],
  ...
  championsLeague: ["Champions League", "Şampiyonlar Ligi"],
  europaLeague: ["Europa League", "Avrupa Ligi"],
  conferenceLeague: ["Conference League", "Konferans Ligi"],
  ...
  lastUclPlace: ["Last Champions League place", "Son Şampiyonlar Ligi sırası"],
  lastEuropeanPlace: ["Last European place", "Son Avrupa kupası sırası"],
  lastSafePlace: ["Last safe place", "Son kalan sıra"],
  raceTitleNote: ["Finishes 1st", "1. bitirir"],
  raceUclNote: ["Finishes 1st or 2nd", "1. veya 2. bitirir"],
  raceEuropeNote: ["Finishes in the top 4", "İlk 4'te bitirir"],
  raceRelNote: ["Finishes in the bottom 3", "Son 3'te bitirir"],
  anyEuropeanPlace: ["Any European place", "Herhangi bir Avrupa kupası"],
